...
import { usePrizePoolAddresses } from '../hooks/usePrizePoolAddresses'
...
export const usePrizePoolContractAddresses = () => {
  ...
  return useQuery(
    [QUERY_KEYS.prizePoolContractAddresses, prizePoolAddresses, chainId],
    async () => {
      return getPrizePoolContractAddresses(readProvider, prizePoolAddresses)
    },
    {
      enabled: isReadProviderReady,
