...
import { useOnboard, useIsWalletOnSupportedNetwork, getAppEnvString } from '@pooltogether/hooks'
import { Modal } from '@pooltogether/react-components'
import { networkBgColorClassname } from '../utils/networkColorClassnames'
import { networkNameToChainId } from '../utils/networkNameToChainId'
...
export function WrongNetworkModal(props) {
  ...
  let supportedNetworkNames = SUPPORTED_CHAIN_IDS[getAppEnvString()].map((_chainId) =>
